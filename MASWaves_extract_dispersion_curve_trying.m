...
Amplitudeatmax = Aplot(I);
Amplitudeatmax = Amplitudeatmax./max(Amplitudeatmax);

% Plot maxima on top of dispersion image
yyaxis left
plot(Amax_fvec_sort,Amax_cvec_sort,'o','MarkerSize',4,'MarkerFaceColor','c','MarkerEdgeColor','k')
yyaxis right
...
if strcmp(up_low_boundary,'yes')
    ...
    % Plot maxima on top of dispersion image
    plot(Amax_fvec_sort_p,Amax_cvec_sort_p,'o','MarkerSize',1,'MarkerFaceColor','c','MarkerEdgeColor','k')
